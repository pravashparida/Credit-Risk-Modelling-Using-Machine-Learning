...
# Load the dataset
a1 = pd.read_excel("C:\\Users\\lenovo\\Downloads\\case_study1.xlsx")
a2 = pd.read_excel("C:\\Users\\lenovo\\Downloads\\case_study2.xlsx")
...
for i in ['MARITALSTATUS', 'EDUCATION', 'GENDER', 'last_prod_enq2', 'first_prod_enq2']:
    ...
    print(i, '---', pval)
# hence all the categorial features have pval < 0.05 we will accept all  
